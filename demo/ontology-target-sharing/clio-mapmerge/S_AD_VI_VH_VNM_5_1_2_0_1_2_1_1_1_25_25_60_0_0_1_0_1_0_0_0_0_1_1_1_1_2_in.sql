...
select x0.tid, 'SK1117(' || (select substr('a'|| x0.last_ad_4_nl0_ae0ke0 || x0.found_ad_4_nl0_ae1 , 1, 10) from dual) || ')', 'SK1084(' || (select substr('a'|| x0.last_ad_4_nl0_ae0ke0 || x0.found_ad_4_nl0_ae1 , 1, 10) from dual) || ')', 'SK1119(' || (select substr('a'|| x0.last_ad_4_nl0_ae0ke0 || x0.found_ad_4_nl0_ae1 , 1, 10) from dual) || ')'
from source.desire_ad_4_nl0_ce0 x0!
